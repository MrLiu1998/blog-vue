    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact animated zoomIn">
          <a class="github circular icon button" data-content="https://github.com/MrLiu1998" data-position="bottom center" style="margin-right: 50px"><i class="github icon"></i></a>
          <a class="wechat circular icon button" style="margin-right: 50px"><i class="weixin icon"></i></a>
          <a class="qq circular icon button" data-content="1109864130" data-position="bottom center"><i class="qq icon"></i></a>
        </div>
        <div class="ui wechat-qr flowing popup transition hidden">
          <img src="http://xrequest.cn/MrLiu.jpg" alt="" class="ui rounded image" style="width: 110px">
        </div>
        <!-- 向下滚动 -->
        ...
        <div class="ui stackable grid">
          ...
          <div class="five wide column" style="left: 34px !important;">
            ...
            <div class="ui centered card my-shadow" style="width: 11em">
              <img src="http://xrequest.cn/MrLiu.jpg" alt="" class="ui rounded image" >
            </div>
          </div>
